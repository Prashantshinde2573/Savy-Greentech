export const pressArticles = [
  {
    ...
    date: 'Feb 2026',
    publication: 'Industrial Product Monitor',
  },
  {
    category: 'The CEO Magazine · May 2026',
  ...
  },
  {
    ...
    date: '2025',
    publication: 'The Policy Times',
  },
  {
    category: 'Business Standard · Jan 2024',
  ...
  {
    category: 'IITRAM · Sep 2023',
    title: 'Chandan Mundhra joins Industry Academia Conclave 2023',
    copy: 'IITRAM hosted Chandan Mundhra, Director of Savy Electric Vehicles, as a panelist for its Industry Academia Conclave discussing future EV technology.',
  ...
  },
  {
    ...
    date: '2021',
    publication: 'Company Milestone',
  },
];

export const amsterdamFeature = {
  title: 'City Pod: Amsterdam & Netherlands E-Mobility Expo Launch',
  subtitle: 'Representing Indian Engineering on the Global Stage',
  date: 'January 2024',
  overview: 'SAVY’s flagship City Pod made waves at the prestigious Netherlands E-Mobility Expo in Amsterdam. Designed as a high-end, aerodynamic micro-mobility auto, it drew significant international attention from European tourism operators, urban planners, and clean-tech investors.',
  highlights: [
    'International spotlight on Indian indigenous EV engineering',
    'High interest from European eco-tourism operators and municipal transit planners',
    'Showcased aerodynamic pod styling, panoramic passenger visibility, and connected telemetry'
  ],
  image: '/assets/news/city-pod-netherlands.jpg'
};

export const awardsExhibitions = [
  {
